<template>
    ...
    <!-- Values Section -->
    <div class="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
        <h2 class="text-lg font-semibold text-gray-900 mb-4 pb-2 border-b border-gray-200">🎨 Caractéristiques de l'option</h2>
        ...
        <div class="space-y-3">
            ...
            <button 
                type="button"
                @click="form.values.push('')"
                class="w-full px-4 py-2 border-2 border-dashed border-gray-300 text-gray-600 rounded-lg hover:border-gray-400 hover:bg-gray-50 flex items-center justify-center font-medium"
            >
